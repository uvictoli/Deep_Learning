...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 4. simply take the input string to be masked_string[:-1], and the output string to be masked_string[1:]
        ...
        x = torch.LongTensor([self.stoi[ch] for ch in input_string])
        y = torch.LongTensor([self.stoi[ch] for ch in output_string])
